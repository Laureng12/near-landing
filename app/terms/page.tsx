      ...
      <main className="legalMain">
        <article className="legalContent">
          ...
          <section className="legalSection">
            ...
            <p>
              Near is an assistive convenience tool, not a guaranteed or fail-safe reminder service. Location detection and notifications depend on factors outside our control - including GPS accuracy, your device settings and permissions, battery level and Low Power Mode, network conditions, and Apple&apos;s location and notification systems - and may be delayed, inaccurate, or fail to appear.
            </p>
            <p>
