...
const styles: Record<string, React.CSSProperties> = {
  ...
  glow: {
    ...
    width: "600px",
    height: "400px",
    background: "radial-gradient(circle, rgba(229,110,142,0.18), rgba(107,92,255,0.10), transparent 65%)",
    filter: "blur(80px)",
    pointerEvents: "none",
  },
  spinnerWrap: {
  ...
  logoIcon: {
    ...
    borderRadius: 8,
    objectFit: "cover",
    boxShadow: "0 0 24px rgba(229,110,142,0.30)",
  },
  logoText: {
    fontSize: 22,
    fontWeight: 800,
  ...
  button: {
    display: "block",
    background: "linear-gradient(90deg, #121C41, #8B2A4A, #E56E8E)",
    color: "#FFFFFF",
    fontWeight: 750,
    fontSize: 16,
    padding: "16px 32px",
    ...
    textDecoration: "none",
    marginBottom: 24,
    boxShadow: "0 12px 40px rgba(229, 110, 142,0.28)",
    letterSpacing: "-0.01em",
  },
  steps: {
