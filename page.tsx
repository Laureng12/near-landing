    ...
    <>
      <style jsx global>{`
        ...
        .featured .tierList li {
          border-color: rgba(255,240,219,0.08);
        }
        .tierCta {
          display: flex;
          align-items: center;
      ...
      <div className="pricingPage">
        <header style={{borderBottom: '1px solid rgba(26,14,31,0.06)', padding: '16px 24px'}}>
          <div style={{maxWidth: '1200px', margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between'}}>
            <Link href="/" className="pricingNavBrand">Near</Link>
            <Link href={APP_STORE_URL} className="tierCta primary" style={{width: 'auto', padding: '10px 20px', fontSize: '13px'}}>Download</Link>
          </div>
        </header>
